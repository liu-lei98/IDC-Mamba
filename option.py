...
parser.add_argument('--template', default='IDCMamba',
...
parser.add_argument('--outf', type=str, default='/root/autodl-tmp/Model/IDCMamba/', help='saving_path')

# Model specifications autodl-tmp/Data/TSA_simu_data/mask_3d_shift.mat
parser.add_argument('--method', type=str, default='IDCMamba_2', help='method name')
